...
export default function Navbar() {
  return (
    <nav className="w-full bg-flow-white/80 dark:bg-flow-black/80 backdrop-blur-sm border-b border-flow-ultra-light-grey dark:border-flow-grey/20 fixed top-0 left-0 right-0 z-50">
